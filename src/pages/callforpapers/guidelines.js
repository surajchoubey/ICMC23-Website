...
function Guidelines() {
    return (
        <div className="container" style={{ marginBottom: '80px' /* marginLeft:"60px", marginTop: "40px", marginRight: '60px'*/ }}>
            ...
            <p style={{ fontWeight: '400' }}>All accepted papers will be published in <a class="modern-link" href={springer_link} target="_blank" rel="nopener noreferrer"> Springer</a> series: <a class="modern-link" href={series_link} target="_blank" rel="nopener noreferrer">Lecture notes in Networks and Systems</a></p>
        </div>
    );
}
