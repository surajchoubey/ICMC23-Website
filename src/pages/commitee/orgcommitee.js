...
class CommitteeMember {
  ...
  static getCards(patronList) {
    return patronList.map(function (patron, _) {
      return (
        <div class="btn-raise raise col-md-4 col-sm-6 col-xs-12 py-3 my-2">
...
function OrgCommittee() {
  return (
    <section style={{textAlign: 'start'}}>
      ...
      <h2 class="heading-secondary my-5">Organizing Chair</h2>
      <div class="row gx-2">
        {CommitteeMember.getCards(OrganizingChair)}
      </div>
      <h2 class="heading-secondary my-5">Organizing Co-Chairs</h2>
      <div class="row gx-2">
        {CommitteeMember.getCards(OrganizingCoChairs)}
      </div>
      <h2 class="heading-secondary my-5">Organizing Committee</h2>
      <div class="row gx-2">
        {CommitteeMember.getCards(OrganizingCommittee)}
      </div>
      <h2 class="heading-secondary my-5">Website Team</h2>
      <div class="row gx-2">{CommitteeMember.getCards(WebsiteTeam)}</div>
    </section>
  );
}
