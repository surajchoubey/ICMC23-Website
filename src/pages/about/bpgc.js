    ...
    <div className="titleStyle1">About the Campus</div>
      ...
      <div className="about-content">
        ...
        <div className="about-mid-grid">
          ...
          />
          <p className="about-txt-cnt">The <a href="https://www.bits-pilani.ac.in/" target="_blank" rel="noopener noreferrer">Birla Institute of Technology &amp; Science, BITS Pilani</a>{aboutText}</p>
